...
<div id="adminheader">
<div id="admin-link"><a href="./">首页  »</a></div>
...
<span class=""><li onmouseover="adminitemhover('new',this)"><a href="login.php?job=logout"><i class="font-icon icon-lock-alt"></i> 退出登录</a></li></span>
</ul>
</div>
</div>
