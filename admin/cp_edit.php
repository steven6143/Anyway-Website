...
if ($job=='add' || $job=='edit') { //Initialize public items
	...
	$quickbutton_bottom="<input type=button value=\"Draft\" class=\"formbutton formbutton2\" onclick=\"savetodraftnow();\";>";
...
<div class="editor-meta-row editor-meta-row-1">
	<div class="editor-meta-column editor-meta-column-1">
		<span class="editor-meta-title">标题</span><input type='text' name='title' id='title' class="editor-controls" value="{$records['title']}"  class='formtext'>
	</div>
	<div class="editor-meta-column editor-meta-column-2">
		 <span class="editor-meta-title">音频地址</span> <input name='comefrom' id='comefrom' type=text value="{$records['comefrom']}">
	</div>
</div>

<div class="editor-meta-row editor-meta-row-2">
	<div class="editor-meta-column editor-meta-column-1">
		<span class="editor-meta-title">URL</span><input type=text class='editor-controls' name='blogalias' id='blogalias' value="{$records['blogalias']}">
	</div>
	<div class="editor-meta-column editor-meta-column-2">
		<span class="editor-meta-title">集数</span><input type=text name='originsrc' id='originsrc' value="{$records['originsrc']}"><span class="editor-meta-title">主播</span><input type='text' name='pinged' id='pinged'  class='formtextarea' value='{$records['pinged']}'>
	</div>
</div>
...
<div class="editor-meta-row editor-meta-row-3">
	<div class="editor-meta-column editor-meta-column-3">
		<span class="editor-meta-title">日志属性</span>{$puttingproperty} 
	</div>
	<div class="editor-meta-column editor-meta-column-3">
		<span class="editor-meta-title">置顶状态</span>{$puttingsticky}
	</div>
	<div class="editor-meta-column editor-meta-column-3">
		<input type=checkbox id='changemytime' name='changemytime' value=1 onclick="timechanger();">&nbsp;更改时间
	</div>
	<div class="editor-meta-column editor-meta-column-3">
		<span class="editor-meta-title">分类</span>{$puttingcates}
	</div>
</div>

</div>

<div style="clear:both; display: none; margin:10px 0 0;" id="changetime"><span class="editor-label"> <input type='text' name='newyear' size='2' value="{$records['pub_year']}" maxlength='4' class='editor-controls-2'>{$lna[291]}  <input type='text' name='newmonth' size='1' value="{$records['pub_month']}" maxlength='2' class='editor-controls-2'>{$lna[292]}  <input type='text' name='newday' size='1' value="{$records['pub_day']}" maxlength='2' class='editor-controls-2'>{$lna[293]}   <input type='text' name='newhour' size='1' value="{$records['pub_hour']}" maxlength='2' class='editor-controls-2'>{$lna[294]}   <input type='text' name='newmin' size='1' value="{$records['pub_min']}" maxlength='2' class='editor-controls-2'>{$lna[295]}<span class="hide"><input type='text' name='newsec' size='1' value="{$records['pub_sec']}" maxlength='2' class='editor-controls-2'></span></span>
</div>
<div style="display:none;"><input type=submit value="{$lna[64]}" id="realsubmit" class="formbutton">{$puttinghtml}<br>{$puttingubb}<br>{$puttingemot}</div>
</form>
