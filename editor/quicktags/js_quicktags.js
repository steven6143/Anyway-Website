...
edButtons.push(
	new edButton(
		'ed_h3'
		,'H2'
		,'<h2><i class="icon-mail-alt"></i><span>'
		,'</span></h2>'
	)
);
...
function edToolbar() {
	document.write('<div id="ed_toolbar"><span><div class="toolbar-submit"><input type=button value="提   交" onclick="chktitle();" class="formbutton entry-submit"></div>');
