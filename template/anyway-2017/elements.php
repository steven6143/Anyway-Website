...
<html xmlns="http://www.w3.org/1999/xhtml" lang="zh-cmn-Hans">
	<head>
		...
		{baseurl}
		<link rel="stylesheet" rev="stylesheet" href="css/2017.css" type="text/css" media="all" />
...
<!--  <script type="text/javascript" src="/anyway/hashover/hashover.js"></script> -->

<div id="disqus_thread"></div>
<script>

var disqus_config = function () {
this.page.url = 'http://Anyway.FM'
this.page.identifier = 'aabbccdd'
};


(function() {
var d = document, s = d.createElement('script');
s.src = 'https://anyway-fm.disqus.com/embed.js';
