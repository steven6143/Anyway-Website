...
$locale = array (
	...
	'comment-formatting'	=> '查看评论须知',
	'accepted-format'	=> '%s',
	'accepted-html'		=> '如果邮箱留空则无头像，注册过 Gravatar 的邮箱地址显示自定义头像，其他邮箱地址则显示随机头像',
	'accepted-markdown'	=> '**显示成粗体粗体**，_加下划线_，*显示成斜体*，~~增加删除线~~，```code```',
	'post-button'		=> '发表评论',
	'login'			=> '登陆',
	'login-tip'		=> '登陆 (可选)',
	'logout'		=> '退出',
	...
	'count-replies'		=> array ('目前有  %d 条评论', '目前有  %d 条评论'),
	'sort'			=> '类别',
	'sort-ascending'	=> '默认',
	...
	'date-month-names'	=> array ('1 月', '2 月', '3 月', '4 月', '5 月', '6 月', '7 月', '8 月', '9 月', '10 月', '11 月', '12 月'),
	'untitled'		=> '无标题',
	'external-image-tip'	=> '点击查看外部图像',
	'loading'		=> '加载中…',
	'click-to-close'	=> '点击关闭',
	'hashover-comments'	=> 'HashOver 评论',
	'rss-feed'		=> 'RSS 订阅',
	'source-code'		=> '源代码'
);
